...
class FileCardsGrid extends StatelessWidget {
  ...
  // Move entityTypeTranslations to class-level
  static final Map<String, String> entityTypeTranslations = {
    'employee': 'Empleados',
    'client': 'Clientes',
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) => _buildFileCard(
            files[index],
            context,
          ),
        );
  ...
  Widget _buildFileCard(FileModel file, BuildContext context) {
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: FileType.pdf.color.withOpacity(0.1),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            // Entity Type moved to here - right after the file name
                            Text(
                              entityTypeTranslations[file.entityType] ??
                                  file.entityType,
