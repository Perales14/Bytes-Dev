...
//   // Inicializa directamente en lugar de usar late
//   EmployeeModel _model = EmployeeModel(
//     nombre: '',
//     apellidoPaterno: '',
//     apellidoMaterno: '',
//     correo: '',
...
//   EmployeeModel get model => _model;

//   set model(EmployeeModel value) {
//     _model = value;
//   }
...
//   // Añade este método a la clase EmployeeFormController
...
//       print('Modelo actualizado exitosamente: ${_model.nombre}');
...
// final formController = Get.put(EmployeeFormController());
